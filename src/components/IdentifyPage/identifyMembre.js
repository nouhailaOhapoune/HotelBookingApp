import './identifyMembre.css';
import { useState } from 'react';
import AirbnbHome from '../HomePage/AirbnbHome';
        ...
        <div className="App">
          ...
          <div className="wrapper">
            <div className="content">
              ...
              <div className="c1">
                <span>Become an member of 'The happy place' today</span>
              </div>
              <div className="form">
